...
This copy is maintained by GitHub user [spanwich](https://github.com/spanwich) as a fork of the upstream [OpenPLC_v3 runtime](https://github.com/thiagoralves/OpenPLC_v3). The fork tracks upstream fixes while enabling embedded system security research, giving researchers a baseline PLC runtime for protocol experiments, hardening strategies, and vulnerability analysis without diverging from the original codebase goals.
